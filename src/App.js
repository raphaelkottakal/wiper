...
class App extends Component {
	...
	componentDidMount() {
		...
		image.onload = ()=>{
			...
			if (imageLoaded && mistLoaded) {
				...
				this.ctx.drawImage(mist,0,0,this.w,this.h);
			}
		};
		...
		mist.src = 'http://assets.myntassets.com/v1479297909/radium/wiper/ImageMyst.jpg';
	...
	handelTouch(e) {
		if (this.state.bothImagesLoaded) {
    ...
    return (
      <div className="App">
        ...
        <div style={css.wrapper}>
        	...
        	<canvas style={css.canvas} onTouchMove={this.handelTouch.bind(this)} ref="myCanvas"></canvas>
        </div>
